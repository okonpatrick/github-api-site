            ...
            {alertVisible && (
              <div
                className={`p-4 rounded-md ${
                  alertType === "success" ? "bg-blue-500" : "bg-red-200"
                }`}
              >
                {alertMessage}
              </div>
            ...
            <form onSubmit={handleSubmit}>
              <div className="flex items-center">
                <input
                  ...
                  className="w-80 px-2 py-4 rounded-md border border-gray-300 focus:outline-none focus:border-blue-500"
                  required
                />
                <button
                  type="submit"
                  className="ml-4 px-6 py-4 bg-blue-500 text-white font-bold rounded-md hover:bg-blue-600 focus:outline-none"
                >
                  Submit
                </button>
              </div>
