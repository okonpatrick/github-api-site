        ...
        <div className="flex flex-wrap items-center justify-center">
          ...
          <div className="sm:w-1/2 text-center ">
            ...
            <p className="text-white text-sm mt-4 text-black dark:text-black">
              © {year}{" "}
              <span className="font-semibold text-black">github api app</span>{" "}
              by <span className="font-semibold">Patrick Anthony</span>
            </p>
          </div>
          <div className="flex m-5 ">
            ...
            <a
              href="https://www.linkedin.com/in/patrick-okon/"
              className="mr-4"
            >
              <div className="bg-gray-600 rounded-3xl p-2">
